...
open class Tab(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs), ICard {
    ...
    init {
        ...
        selectColor = ta.getColor(R.styleable.Tab_tab_select_tx_color, Color.BLACK)
        unSelectColor = ta.getColor(R.styleable.Tab_tab_unselect_tx_color, Color.GRAY)
